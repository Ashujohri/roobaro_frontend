          ...
          <div className="newvisitorbox">
            <div className="subcontainerbox">
              <Grid container spacing={2}>
                <Grid item xs={12} sm={12}>
                  <div className="heading">Enter Visitor Details</div>
                </Grid>
                <Grid
                  item
                  xs={12}
                  ...
                  >
                    <ToggleButton
                      style={{
                        ...
                        fontFamily: "Poppins",
                        marginRight: 10,
                        color: VisitorType ? "primary" : "secondary",
                      }}
                ...
                {VisitorType === "single" ? (
                  <>
                    <Grid item xs={12} sm={1.5}>
                      <div className="label">Name (Primary)</div>
                    </Grid>
                      ...
                      return (
                        <>
                          <Grid item xs={12} sm={1.5}>
                            <div>
                              {index == 0 ? (
                                <div className="label"> Name (Second Primary)</div>
                              ) : (
                                <div className="label">{index + 1}nd Person Name </div>
                              )}
                            </div>
                          </Grid>
            ...
            <Stack spacing={3}>
              ...
              />
                ...
                <Grid item xs={12} sm={1.5}>
                  <div className="label">Physically disabled:</div>
                </Grid>
                ...
                <Grid item xs={12} sm={5.5}>
                  {Image ? <><img src={Image} alt="Taken photo" width="90%" height="100%" /></> : <></>}
                </Grid>
