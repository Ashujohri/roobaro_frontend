    ...
    <>
      ...
      >
              ...
              <>
                <Grid item xs={12} sm={1.5}>
                  <div className={classes.label} >
                    {index == 0 ? <> Name (Primary)</> : <>{index + 1}nd Person Name </>}
                  </div>
                </Grid>
                <Grid item xs={10} sm={10.2}>
                  <TextField
                ...
                <Grid item xs={2} sm={0.3} sx={{ display: 'flex', justifyContent: 'right' }} >
                  {index == 0 ?
                    <>
                      {names.length == 10 ?
                        <>
                          <IconButton disabled color='primary' onClick={() => handleAdd()}>
        ...
        <Grid item xs={12} sm={10.5}>
          <FormControl sx={{ width: "100%", fontFamily: "Poppins", color: "#000000", fontWeight: 'bold' }} size="small">
        ...
        <Grid item xs={12} sm={10.5}>
          <FormControl sx={{ width: "100%", fontFamily: "Poppins", color: "#000000", fontWeight: 'bold' }} size="small">
            <InputLabel id="demo-multiple-name-label">Vidhansabha</InputLabel>
            <Select
              labelId="demo-multiple-name-label"
              id="demo-multiple-name"
              value={location}
